...
## 2. Co już masz dobrze (nie zmieniaj kierunku)

| Masz | Dlaczego to wygrywa |
|------|---------------------|
| Fokus: dorośli + mówienie | Konkret vs Tutlo/Preply/giełdy |
| Test bariery + konsultacja 0 zł | Usuwa strach przed startem |
| LingoLogy App między lekcjami | Unik na rynku PL |
...
## 3. Umawianie terminów — Lingotutor (NIE Calendly)

Calendly = ktoś klika wolny slot, podaje dane, dostaje potwierdzenie.  
**Lingotutor robi to samo** → nie wdrażaj Calendly.
